                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="home-showcase__image">
                                                            ...
                                                            <div class="home-showcase__buttons">
                                                                ...
                                                                <a href="index-one-page.html"
                                                                    class="ogency-btn home-showcase__buttons__item">One
                                                                    Page</a>
                                                            </div>
                                                            <!-- /.home-showcase__buttons -->
                                                        </div><!-- /.home-showcase__image -->
                                                        <h3 class="home-showcase__title">Homepage 01</h3>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="home-showcase__item">
                                                        ...
                                                        <h3 class="home-showcase__title">Homepage 02</h3>
                                                        <!-- /.home-showcase__title -->
                                                    </div><!-- /.home-showcase__item -->
                                                </div><!-- /.col-lg-3 -->
                                                <div class="col-lg-3">
                                                    <div class="home-showcase__item">
                                                        ...
                                                        <h3 class="home-showcase__title">Homepage 03</h3>
                                                        <!-- /.home-showcase__title -->
                                                    </div><!-- /.home-showcase__item -->
                                                </div><!-- /.col-lg-3 -->
                                                <div class="col-lg-3">
                                                        ...
                                                        <div class="home-showcase__image">
                                                            ...
                                                            <div class="home-showcase__buttons">
                                                                <a href="index-light.html"
                                                                    class="ogency-btn home-showcase__buttons__item">View
                                                                    Page</a>
                                                            </div>
                                                            <!-- /.home-showcase__buttons -->
                                                        </div><!-- /.home-showcase__image -->
                                                        <h3 class="home-showcase__title">Homepage 04</h3>
                                                        <!-- /.home-showcase__title -->
                                                    </div><!-- /.home-showcase__item -->
                                                </div><!-- /.col-lg-3 -->
                                            </div><!-- /.row -->
